...
class EmergencyContact2Screen extends StatefulWidget {
  @override
  _EmergencyContact2ScreenState createState() => _EmergencyContact2ScreenState();
}

class _EmergencyContact2ScreenState extends State<EmergencyContact2Screen> {
        ...
        content: Column(
          ...
          children: [
            ListTile(
              ...
              title: Text('Ahmad Rizki'),
              subtitle: Text('081234567892'),
              onTap: () {
                setState(() {
                  _nameController.text = 'Ahmad Rizki';
                  _phoneController.text = '081234567892';
                });
            ...
            ListTile(
              leading: Icon(Icons.person),
              title: Text('Dewi Sartika'),
              subtitle: Text('081234567893'),
              onTap: () {
                setState(() {
                  _nameController.text = 'Dewi Sartika';
                  _phoneController.text = '081234567893';
                });
                Navigator.pop(context);
              },
            ),
